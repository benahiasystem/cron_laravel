...
<head>
  ...
  .link{color:#45af6d;}
  .content-email{border-radius: 5px; background:#fff; padding: 20px 10px 20px 10px;}
      ...
      <tr>
        <td class="header">
          <table width="200" align="left" border="0" cellpadding="0" cellspacing="0">  
            <tr>
              <td height="70" style="padding: 0px;">
                <img class="fix" src="https://vendty.com/wp-content/uploads/2019/05/logo.png" width="100%" border="0" alt="" style="margin-left:1rem;"/>
              </td>
            </tr>
          </table>
        </td>
        ...
        <td class="innerpadding2" style="background:#F3F3F3;">
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="innerpadding2 content-email">
            ...
            <tr>
              <td class="bodycopy">
                <p> 
                    Hemos notado que aun no has completado con exito tus primeros pasos. <br>
                    ¡Estas a solo <?= ($step > 1)? $step.' pasos' : $step.' paso' ?> ! <br>
                    Te invitamos a finalizar la configuración de tu negocio haciendo clic 
                    <a target="_blank" href="https://pos.vendty.com" class="link">AQUÍ</a>.<br><br>
                    Recuerda que si tienes alguna duda y necesitas una demostración la puedes agendar <a target="_blank" href="https://app.hubspot.com/meetings/demostracion/general" class="link">AQUÍ</a>.<br><br>
                    <b>Atentamente: Roxanna Vergara</b><br><br>
