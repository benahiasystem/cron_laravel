...
<head>
    ...
    <title>VENDTY - MODELO DE CORREO ELECTRÓNICO</title>
    <style>
        body {
            margin: 0;
            padding: 0;
        ...
        @media only screen and (max-width: 480px) {
            ...
            .templateColumnContainer tbody {
                width: 100%;
                display: block;
            }
            .templateColumnContainer tbody tr {
                width: 100%;
                display: inline-table;
                padding-left: 5%;
            }
            .templateColumnContainer tbody tr td {
                vertical-align: top;
            }
        }
    </style>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="innerpadding2 content-email">
                            ...
                            <tr>
                                <td class="bodycopy">
                                    <p>
                                        Hola name <br><br>
                                        Gracias por adquirir Vendty, a continuación algunos enlaces de tu Interés : <br><br>
                                        <ul>
                                            <li><b><a style="color:#45af6d;" href='https://app.hubspot.com/meetings/capacitacion/resolucion-dudas' target='_blank'>Agenda Tu Capacitación</a></b></li>
                                            <li><b><a style="color:#45af6d;" href='https://www.youtube.com/watch?v=FzxsXoedabc&list=PL9IVF-H3Eg6yKAJLTnMIJvB19thFyzoCF' target='_blank'>Vídeo Tutoriales</a></b></li>
                                            <li>Horario de Atención: Lunes-Viernes: <b>8AM a 6PM</b>, Sábado: <b>9AM- 1PM</b> </li>
                                            <li><b><a style="color:#45af6d;" href='https://vendty.com/ayuda/' target='_blank'>Ayuda en Línea</a></b></li>
                                            <li><b><a style="color:#45af6d;" href='http://www.vendty.com/blog/' target='_blank'>Blog</a></b></li>
                                            <li><b><a style="color:#45af6d;" href='https://pos.vendty.com/' target='_blank'>Entrar al Sistema</a></b></li>
                                        </ul>
                                        Esperamos que Vendty sea de gran ayuda para el desarrollo de tu empresa
                                        <br>
                                        ¡Muchos Éxitos!<br>
                                        <br>
