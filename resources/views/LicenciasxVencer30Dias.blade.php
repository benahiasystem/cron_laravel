                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="innerpadding2 content-email">
                                                    ...
                                                    @foreach ($licencias as $key)
                                                        @if($email == $key['email'])
                                                            <tr align="center" valign="middle" style="color:#505050">
                                                                ...
                                                                <td style="color:#505050">{{ ucfirst(strtoupper($almacen)) }}</td>
                                ...
                                <tr>
                                    <td colspan=6 class="alert alert-warning" align="justify" valign="top">
                                        ...
                                        <i style="font-size:13px ">Nos encantaría que siguiera usando nuestros servicios, pero como en Vendty no hay cláusula de permanencia es su decisión continuar. Si no desea renovar le pedimos que descargue su información en archivos de Excel en la opción de Informes del sistema. Recuerde que su información será borrada de nuestros servidores pasados 30 días calendario y no podrá acceder a ella si está suspendido.</i>
                                    </td>
                                </tr>
                            </table>
                        </td>
